...
setwd(file.path('D:', 'species_2025', '12_species_detection'))

data1 <- read.table ("2_species_annot_convert.csv", sep =",", header=TRUE, fill=TRUE)
...
write.table(data1,"2_species_annot_convert2.csv.csv", col.names=TRUE, row.names=FALSE, sep=",")
