...
# Inputs
csv_train = "H:/WHCR_2025/1_classify/DATASET_classify_v6/classify_test_v6.csv"
csv_test = "H:/WHCR_2025/1_classify/DATASET_classify_v6/classify_train_v6.csv"
...
for epoch in range(1,n_epoch+1):
    ...
    Classification_utils.train_MBC.train(epoch=epoch, model=model, train_loader=train_loader, device=device1, optimizer=optimizer, criterion=criterion)
    Classification_utils.test_MBC.test(model=model, test_loader=test_loader, device=device1, criterion=criterion)
    e1 = e1 + 1
...
#model_scripted.save('F:/WHCR_2025/6_classify/May4_2026_datasetv5_swin_s_noage.pt')
