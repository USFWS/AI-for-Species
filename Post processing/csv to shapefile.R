...
setwd(file.path('D:', 'species_2025', '15_species_survey'))

data1 <- read.table ("predict_species_2025_survey_Sept15.csv", sep = ",",header=TRUE, fill=TRUE)
...
export_spatial = "species_predict_survey_2025.shp"
